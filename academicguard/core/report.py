...
class AnalysisReport:
    ...
    def _render_html(self) -> str:
        ...
        return tmpl.render(report=self, data=self.to_dict(), version=__version__)
...
<footer>Generated by <strong>AcademicGuard v{{ version }}</strong> -- Open Source Academic Writing Integrity Toolkit</footer>
</body>
</html>
"""
